    ...
    forms.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (data.type === 'redirect') {
                ...
                document.getElementById('type_name_td_unlisted' + id).innerHTML = data.text
...
function reload() {
    setTimeout(() => {
        window.location.href = '/admin/unlistedTypes'
    }, 400);
}
...
async function listType(id) {
    ...
    try {
        ...
        const resp = await fetch(`/admin/type/list`, {
            method: 'PATCH',
            headers: {
                'Content-type': 'application/json'
            },
