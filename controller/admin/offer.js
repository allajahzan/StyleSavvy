...
exports.addOffers = async (req, res) => {
    try {
        ...
        const { offer_name, offerType, itemId, typeName, offer, redeem_amount, expiryDate } = req.body
        ...
        if (offerType === 'product') {
            ...
            const newOffer = new Offer({ offer_name, offerType, productId: itemId, typeName, offer: Number(offer), redeem_amount, expiryDate })
            ...
            const newOffer = new Offer({ offer_name, offerType, categoryId: itemId, typeName, offer: Number(offer), redeem_amount, expiryDate })
...
exports.editOffers = async (req, res) => {
    try {
        ...
        const { offerId, offer_name, offerType, itemId, typeName, offer, redeem_amount, expiryDate } = req.body
        ...
        if (offerType === 'product') {
            ...
            offerToEdit.expiryDate = expiryDate
