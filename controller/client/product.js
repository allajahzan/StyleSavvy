...
exports.getProductsPage = async (req, res) => {
  try {
    ...
    res.render('products', { user: user.name, varients: varients, totalPages, currentPage, totalVarients, select, type, category, colors ,searchQuery})
  } catch (err) {
    console.log(err);
    res.render('500')
  }
...
exports.getProductsDetails = async (req, res) => {
  ...
  try {
    // to get main details of product
    ...
    // if (product) {
      ...
      // to get the details of that perticular varient
      ...
      if (varient) {
        ...
        res.render('productDetails', { user: user.name, varient:varient[0] , relatedProducts:relatedProducts })
